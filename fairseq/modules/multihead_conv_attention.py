...
class MultiheadConvAttention(nn.Module):
    ...
    kernel_size=4):
        ...
        self.conv_layer_K = nn.Conv1d(embed_dim, embed_dim, self.kernel_size, stride = self.kernel_size)
        self.conv_layer_V = nn.Conv1d(embed_dim, embed_dim, self.kernel_size, stride = self.kernel_size)
    ...
    def forward(self, query, key, value, key_padding_mask=None, incremental_state=None,
        ...
        assert list(attn_weights.size()) == [bsz * self.num_heads, tgt_len, conv_src_len]
        ...
        if key_padding_mask is not None:
            ...
            attn_weights = attn_weights.view(bsz, self.num_heads, tgt_len, conv_src_len)
            if self.onnx_trace:
